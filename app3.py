...
.match-wrap {
    background: linear-gradient(135deg, #0f0000, #180000);
...
.song-idx { font-family: 'Orbitron', monospace !important; font-size: 0.6rem; color: #cc0000; width: 28px; flex-shrink: 0; }
.song-nm  { color: #ffffff; font-size: 0.95rem; font-weight: 600; flex: 1; padding: 0 14px; }
.song-fp  { font-family: 'Orbitron', monospace !important; font-size: 0.65rem; color: #ffffff30; letter-spacing: 1px; }

.red-line { width: 100%; height: 1px; background: linear-gradient(90deg, transparent, #cc0000, transparent); margin: 1.5rem 0; }
...
.stButton > button {
    ...
    width: 100% !important;
    box-shadow: 0 0 20px #cc000040 !important;
}
.stButton > button:hover {
    background: #ff0000 !important;
    box-shadow: 0 0 40px #cc000070 !important;
}
...
.stTabs [data-baseweb="tab-panel"] { background: #000000 !important; padding-top: 1rem !important; }
...
[data-testid="metric-container"] {
    background: #080808 !important;
    border: 1px solid #cc000020 !important;
    border-top: 3px solid #cc0000 !important;
    border-radius: 2px !important;
    padding: 16px !important;
}
[data-testid="stMetricLabel"] { color: #ffffff40 !important; font-size: 0.7rem !important; letter-spacing: 2px; }
...
def plot_spectrogram(S_db, sr, hop):
    ...
    ax.set_title("SPECTROGRAM", fontsize=11, color='#ffffff80')
...
def plot_constellation(S_db, sr, hop, peak_times, peak_freqs):
    ...
    ax.set_title("CONSTELLATION MAP", fontsize=11, color='#ffffff80')
    plt.tight_layout()
    return fig
...
def plot_histogram(all_hist, best_song):
    ...
    ax.set_title("OFFSET HISTOGRAM", fontsize=11, color='#ffffff80')
...
st.markdown(f"""
<div class="hero-wrap">
    <div class="hero-bg-text">SONGID</div>
    ...
    if uploaded:
        ...
        <div class="match-wrap">
            ...
            <div class="match-meta">
                Peak Count: <b>{count}</b> &nbsp;|&nbsp;
                Hashes: <b>{len(result['hashes']):,}</b> &nbsp;|&nbsp;
                Sample Rate: <b>{result['sr']} Hz</b>
            </div>
...
with tab2:
    ...
    if files:
        ...
        if st.button("IDENTIFY ALL"):
            ...
            status.markdown('<span style="color:#cc0000;font-family:monospace;">✓ COMPLETE</span>', unsafe_allow_html=True)
